...
Deno.test("module is imported: 'isNumber()'", () => {
  if (!isNumber) {
    throw Error("missing module");
  }
});

Deno.test("module is imported: 'isString()'", () => {
  if (!isString) {
    throw Error("missing module");
  }
});
...
Deno.test("'module tests' : check is string (text)", () => {
  const actual1 = true;
  const test1 = isString("This is a test string.");
  assertEquals(test1, actual1);
});

Deno.test("'module tests' : check is string (variable)", () => {
  const actual2 = true;
...
Deno.test("'module tests' : check number is string (false)", () => {
  const actual3 = false;
  const testData3 = 33;
...
Deno.test("'module tests' : check boolean is string (false)", () => {
  const actual4 = false;
...
Deno.test("'module tests' : check object is string (false)", () => {
  const actual5 = false;
...
Deno.test("'module tests' : check undefined is string (false)", () => {
  const actual6 = false;
...
Deno.test("'module tests' : check is Number (number)", () => {
  const actual1 = true;
  const test1 = isNumber(22);
  assertEquals(test1, actual1);
});

Deno.test("'module tests' : check is Number (variable)", () => {
  const actual2 = true;
  const testData2 = 22;
...
Deno.test("'module tests' : check string is Number (false)", () => {
  const actual3 = false;
...
Deno.test("'module tests' : check boolean is Number (false)", () => {
  const actual4 = false;
  const testData4 = true;
...
Deno.test("'module tests' : check object is Number (false)", () => {
  const actual5 = false;
  const testData5 = { "test": 123 };
...
Deno.test("'module tests' : check undefined is Number (false)", () => {
  const actual6 = false;
  const testData6 = undefined;
  const test6 = isString(testData6);
  assertEquals(test6, actual6);
